				...
				$("#submitBtn").click(function(){
					...
					if (validate){
						 ...
						 */
						 ...
						 $.post("${path}/basic/updateRegion.jspx",params,function(data,status){
				...
				<tr>
					...
					<td><input type="text" name="region.province" class="easyui-textbox"
							...
							data-options="required:true,
										  tipPosition:'bottom',
										  missingMessage:'省份不能为空！'"
							value="${region.province}"/></td>
				</tr>
				<tr>
					<td>市名：</td>
					<td><input type="text" name="region.city" class="easyui-textbox"
							...
							data-options="required:true,
										  tipPosition:'bottom',
										  missingMessage:'市名不能为空！'"
							value="${region.city}"/></td>
				</tr>
				<tr>
					<td>区名：</td>
					<td><input type="text" name="region.district" class="easyui-textbox"
							...
							data-options="required:true,
										  tipPosition:'bottom',
										  missingMessage:'区名不能为空！'"
							value="${region.district}"/></td>
				</tr>
				<tr>
					<td>邮编：</td>
					<td><input type="text" name="region.postCode" class="easyui-textbox"
							...
							data-options="required:true,
										  tipPosition:'bottom',
										  missingMessage:'邮编不能为空！'"
							value="${region.postCode}"/></td>
				</tr>
				<tr align="center">
					<td colspan="2">
