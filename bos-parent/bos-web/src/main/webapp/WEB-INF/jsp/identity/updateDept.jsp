...
<html>
		...
		<script type="text/javascript">
			$(function(){
				...
				$("#submitBtn").click(function(){
					/** 获取表单，开启校验 */
					var validate = $("#deptForm").form("enableValidation") // 启用验证
					...
					if (validate){
						 ...
						 * 第四个参数：服务器响应回来的数据类型
						 */
						 var params = $("#deptForm").serialize(); // 把表单序列化成get请求参数字符串
						 $.post("${path}/identity/updateDept.jspx",params,function(data,status){
	...
	<body>
		<form id="deptForm" class="easyui-form"  data-options="novalidate:true">
			<input type="hidden" value="${dept.id}" name="dept.id"/>
			<table align="center" cellpadding="2" style="padding-top: 2px;">
				<tr>
					<td>名称：</td>
					<td><input type="text" name="dept.name" class="easyui-textbox"
					        style="width:258px;"
				...
				<tr>
					...
					<td><textarea type="text" 
						...
						data-options="required:true,
									  tipPosition:'bottom',
									  missingMessage:'备注不能为空！'">${dept.remark}</textarea></td>
				</tr>
				<tr align="center">
					<td colspan="2">
