...
<html>
		...
		<script type="text/javascript">
			$(function(){
				...
				$("#submitBtn").click(function(){
					/** 获取表单，开启校验 */
					var validate = $("#jobForm").form("enableValidation") // 启用验证
					...
					if (validate){
						 ...
						 * 第四个参数：服务器响应回来的数据类型
						 */
						 var params = $("#jobForm").serialize(); // 把表单序列化成get请求参数字符串
						 $.post("${path}/identity/addJob.jspx",params,function(data,status){
	...
	<body>
		<form id="jobForm" class="easyui-form"  data-options="novalidate:true">
			<table align="center" cellpadding="2" style="padding-top: 2px;">
				<tr>
					<td>名称：</td>
					<td><input type="text" name="job.name" class="easyui-textbox"
					        style="width:258px;"
