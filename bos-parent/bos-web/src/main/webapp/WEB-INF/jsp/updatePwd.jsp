				...
				$("#submitBtn").click(function(){
					...
					if (validate){
						 ...
						 */
						 ...
						 $.post("${path}/updatePwd.jspx",params,function(data,status){
							// status : success、error 状态码
							// data : 响应数据 {}、[]、[{},{}]、1、true $.parseJSON() 1或0
							if (status == "success"){
								if (data == 1){
									parent.location.href = "${path}/logout.jspx";
								}else{
									$("#tip").text("修改失败！");
								}
							}
	...
	<body>
		<form id="pwdForm" class="easyui-form"  data-options="novalidate:true">
			<table align="center" cellpadding="4" style="padding-top: 2px;">
				<tr>
					<td>旧的密码：</td>
					<td><input type="password" name="oldPwd" class="easyui-textbox" size="28"
							data-options="required:true,
										  tipPosition:'bottom',
										  missingMessage:'旧密码不能为空！'"
							validType="length[6,20]"
							invalidMessage="旧密码格式不正确！"/></td>
				</tr>
				<tr>
					<td>新的密码：</td>
