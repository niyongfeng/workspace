...
<body>
			...
			<div class="span3">
				<div class="sidebar-nav">
					...
					<ul id="accounts-menu" class="nav nav-list collapse in">
						...
						<li class="active"><a href="teacherCompetitionManage.jsp">竞赛活动发布管理</a></li>
			...
			<div class="span9">
				...
				<div class="well">
					<ul class="nav nav-tabs">
						...
						<li><a href="#show" data-toggle="tab">我发布的竞赛活动</a></li>
					</ul>
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active in" id="home">
							<form id="tab2" action="teacherUpdateCompetition" method="get">
								<script type="text/javascript"
									src="javascripts/teacherMyCompetition.js"></script>
								<script type="text/javascript">
									select();
								</script>
								...
								<label>地点</label> <input name="address" type="text"
									...
									style="display: none">
								<div>
									<button class="btn btn-primary" style="">提交修改</button>
								</div>
							</form>
						</div>
						<div class="tab-pane fade" id="profile">
							<form id="tab" action="CompetitionManageServlet" method="get">
 ...
 $("#search").click(function(){
			...
			$.ajax({
				type : "get",
				url : 'searchMyCompetition', // 提交到一般处理程序请求数据
				data:{info:info},
				...
				success : function(data) {
					...
					for (var i = 0; i < json.length; i++) {
						...
						var str = "<tr><td>"
								...
								+ "</td><td><a href=\"teacherCompetitionManage.jsp?id="  +val.id + "\"role=\"button\" data-toggle=\"modal\"><i class=\"icon-pencil\"></i></a>&nbsp;&nbsp<a href=\"#\" role=\"button\" data-toggle=\"modal\" onclick='deleteChair($(this))'><i class=\"icon-remove\"></i></a></td></tr>";
								
						$("#myCompetitionList").after(str);
					};
					$("#Pagination").hide();
