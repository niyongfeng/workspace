...
<script type="text/javascript" src="javascripts/manChair.js"></script>
...
<body>
			...
			<div class="span3">
				<div class="sidebar-nav">
					...
					<ul id="dashboard-menu" class="nav nav-list collapse in">
						...
						<li class="active"><a href="manChair.jsp">讲座</a></li>
 ...
 $("#search").click(function(){
			...
			$.ajax({
				type : "get",
				url : 'searchManChair', // 提交到一般处理程序请求数据
				data:{info:info},
				...
				success : function(data) {
					...
					for (var i = 0; i < json.length; i++) {
						...
						var str = "<tr><td>"+ (json.length - i)
								...
								+ "</td><td><a href=\"manChairManage.jsp?id="  +val.id + "\"role=\"button\" data-toggle=\"modal\"><i class=\"icon-pencil\"></i></a>&nbsp;&nbsp<a href=\"#\" role=\"button\" data-toggle=\"modal\" onclick='deleteChair($(this))'><i class=\"icon-remove\"></i></a></td></tr>";
