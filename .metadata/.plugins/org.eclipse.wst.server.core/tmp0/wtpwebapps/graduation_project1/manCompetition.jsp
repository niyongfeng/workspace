...
<script type="text/javascript" src="javascripts/manCompetition.js"></script>
...
<body>
			...
			<div class="span3">
				<div class="sidebar-nav">
					...
					<ul id="dashboard-menu" class="nav nav-list collapse in">
						...
						<li class="active"><a href="manCompetition.jsp">竞赛活动</a></li>
	...
	<script type="text/javascript">
					$("#search").click(function(){
							...
							$.ajax({
								type : "get",
								url : 'searchManCompetition', // 提交到一般处理程序请求数据
								data:{info:info},
