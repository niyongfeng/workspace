...
<script type="text/javascript" src="javascripts/manTeacherProject.js"></script>
...
<body>
		...
		<div class="row-fluid">
			<div class="span3">
				<div class="sidebar-nav">
					...
					<ul id="dashboard-menu" class="nav nav-list collapse in">
						...
						<li class="active"><a href="manTeacherProject.jsp">教师项目</a></li>
			...
			<div class="span9">
				...
				<script type="text/javascript"
					src="javascripts/manTeacherProject.js"></script>
				<script type="text/javascript">
					select();
				</script>
 ...
 $("#search").click(function(){
			...
			$.ajax({
				type : "get",
				url : 'searchManTeacherProject', // 提交到一般处理程序请求数据
				data:{info:info},
