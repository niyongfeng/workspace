...
function loadData() {
	$.ajax({
		type : "get",
		url : "manVolunteerActivityServlet",
		async : false,
		cache : false,
...
function select(){
	...
	$.ajax({
		type : "get",
		url : 'manUpdateVolunteerActivityId', 
		data:$.param({id:id}),
...
$(function() {
	...
	function InitTable(pageIndex) {
		$
				.ajax({
					type : "get",
					url : 'manVolunteerActivityServlet?pageIndex=' + pageIndex
					...
					success : function(data) {
						...
						for (var i = 0; i < json.length; i++) {
							...
							var str = "<tr><td>"
								...
								+ val.id
								+ "</td><td><a href=\"manVolunteerActivityManage.jsp?id=" + val.id + "\"role=\"button\" data-toggle=\"modal\"><i class=\"icon-pencil\"></i></a>&nbsp;&nbsp<a href=\"#\" role=\"button\" data-toggle=\"modal\" onclick='deleteChair($(this))'><i class=\"icon-remove\"></i></a>&nbsp;&nbsp<a href=\"stunum2.jsp?id="
								+ val.id
