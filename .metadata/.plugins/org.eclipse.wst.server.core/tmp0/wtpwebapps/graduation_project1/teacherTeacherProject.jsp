...
<script type="text/javascript" src="javascripts/teacherProject.js"></script>
...
<body>
		...
		<div class="row-fluid">
			<div class="span3">
				<div class="sidebar-nav">
					...
					<ul id="dashboard-menu" class="nav nav-list collapse in">
						...
						<li class="active"><a href="teacherTeacherProject.jsp">教师项目</a></li>
			...
			<div class="span9">
				...
				<div class="well search-well">
					<form class="form-inline" action="TeacherProjectSearchSerlvet"
						method="get">
						<input name="info" class="input-xlarge" id="appendedInputButton"
							type="text">
 ...
 $("#search").click(function(){
			...
			$.ajax({
				type : "get",
				url : 'searchTeacherProject', // 提交到一般处理程序请求数据
				data:{info:info},
