 ...
 * Generated at: 2017-05-15 01:15:18 UTC
...
public final class studentIndex_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if (user == null) {
      ...
      out.write("\t\t\t\t\t<h3 style=\"text-indent: 2em\">学生参加的社会实践、志愿服务、学术讲座、读百部书看百部电影、文艺活动、体育比赛等活动，可根据活动过程或取得的成果获得学分，本模块不少于5分。</h3>\n");
      out.write("\t\t\t\t\t<h2>2、创新实践模块</h2>\n");
      out.write("\t\t\t\t\t<h3 style=\"text-indent: 2em\">学生参加竞赛项目、创新训练项目、教师工作室项目、产学研合作项目以及公开发表论文作品等，经认定可获得相应学分，本模块不少于2学分。</h3>\n");
      out.write("\t\t\t\t\t<h2>3、其他模块</h2>\n");
      out.write("\t\t\t\t\t<h3 style=\"text-indent: 2em\">学生参加学校或学校认可的机构组织的大学生自主创业、职业技能和资格证书、就业创业培训等活动，获取相应成绩或证书，可获得这类学分。</h3>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t</div>\n");
      out.write("\t</div>\n");
