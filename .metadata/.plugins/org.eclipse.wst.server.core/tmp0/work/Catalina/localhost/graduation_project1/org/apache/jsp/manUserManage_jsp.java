 ...
 * Generated at: 2017-05-01 03:44:43 UTC
...
public final class manUserManage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if (user == null) {
      ...
      out.write("\t\t\t\t\t\t<li class=\"active\"><a href=\"manUserManage.jsp\">用户管理</a></li>\n");
      out.write("\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<div class=\"span9\">\n");
      out.write("\t\t\t\t<h1 class=\"page-title\">用户管理</h1>\n");
      ...
      out.write("\t\t\t\t\t\t<li><a href=\"#profile\" data-toggle=\"tab\">添加</a></li>\n");
      out.write("\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t<div id=\"myTabContent\" class=\"tab-content\">\n");
      out.write("\t\t\t\t\t\t<div class=\"tab-pane active in\" id=\"home\">\n");
      out.write("\t\t\t\t\t\t\t<form id=\"tab\" action=\"UpdateUser\" method=\"get\">\n");
      out.write("\t\t\t\t\t\t\t\t<script type=\"text/javascript\"\n");
      out.write("\t\t\t\t\t\t\t\t\tsrc=\"javascripts/manUserManage.js\"></script>\n");
      out.write("\t\t\t\t\t\t\t\t<script type=\"text/javascript\">\n");
      out.write("\t\t\t\t\t\t\t\t\tselect();\n");
      out.write("\t\t\t\t\t\t\t\t</script>\n");
      out.write("\t\t\t\t\t\t\t\t<label>用户名</label> <input name=\"username\" type=\"text\"\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"input-xlarge\" readonly> <label>用户状态</label>\n");
      out.write("\t\t\t\t\t\t\t\t<!-- <input type=\"text\" class=\"input-xlarge\"> -->\n");
      out.write("\t\t\t\t\t\t\t\t<select id=\"code\" name=\"status\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"2\">请选择</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"1\">可用</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"0\">注销</option>\n");
      out.write("\t\t\t\t\t\t\t\t</select> <label>密码</label> <input name=\"userpwd\" type=\"text\"\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"input-xlarge\"> <label>权限</label>\n");
      out.write("\t\t\t\t\t\t\t\t<!--  <input type=\"text\" value =\"学生/教师/管理员\" class=\"input-xlarge\"> -->\n");
      out.write("\t\t\t\t\t\t\t\t<select id=\"code1\" name=\"code\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"0\">请选择</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"1\">学生用户</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"2\">教师用户</option>\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"3\">管理员用户</option>\n");
      out.write("\t\t\t\t\t\t\t\t</select>\n");
      out.write("\t\t\t\t\t\t\t\t<div>\n");
      ...
      out.write("\t\t\t\t\t\t\t<form id=\"tab2\" action=\"UpdateUser2\" method=\"post\">\n");
      out.write("\t\t\t\t\t\t\t\t<label>用户名</label> <input name = \"username\" type=\"text\" class=\"input-xlarge\">\n");
      out.write("\t\t\t\t\t\t\t\t<!-- <input type=\"text\" class=\"input-xlarge\"> -->\n");
      out.write("\t\t\t\t\t\t\t\t<label>密码</label> <input name = \"userpwd\" type=\"text\" class=\"input-xlarge\">\n");
