 ...
 * Generated at: 2017-04-21 09:16:43 UTC
...
public final class studentCompetition2_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<script type=\"text/javascript\" src=\"javascripts/competition.js\"></script>\n");
      out.write("\n");
	...
	if (user == null) {
      ...
      out.write("\t\t\t\t\t\t<li><a href=\"studentVolunteerActivity.jsp\">志愿者活动</a></li>\n");
      out.write("\t\t\t\t\t\t<li class=\"active\"><a href=\"studentCompetition.jsp\">竞赛活动</a></li>\n");
      ...
      out.write("\t\t\t\t\tsrc=\"javascripts/jquery.jqplot.min.js\"></script>\n");
      ...
      out.write("\t\t\t\t\t\tInitTable(0); // Load事件，初始化表格数据，页面索引为0（第一页）\n");
      out.write("\t\t\t\t\t\t// 分页，PageCount是总条目数，这是必选参数，其它参数都是可选\n");
      out.write("\t\t\t\t\t\t$(\"#Pagination\").pagination(pcount, {\n");
      out.write("\t\t\t\t\t\t\tcallback : PageCallback, // PageCallback() 为翻页调用次函数。\n");
      out.write("\t\t\t\t\t\t\tprev_text : \"« 上一页\",\n");
      out.write("\t\t\t\t\t\t\tnext_text : \"下一页 »\",\n");
      out.write("\t\t\t\t\t\t\titems_per_page : pageSize,\n");
      out.write("\t\t\t\t\t\t\tnum_edge_entries : 2, // 两侧首尾分页条目数\n");
      out.write("\t\t\t\t\t\t\tnum_display_entries : 6, // 连续分页主体部分分页条目数\n");
      out.write("\t\t\t\t\t\t\tcurrent_page : pageIndex, // 当前页索引\n");
      out.write("\t\t\t\t\t\t});\n");
      out.write("\t\t\t\t\t\t// 翻页调用\n");
      out.write("\t\t\t\t\t\tfunction PageCallback(index, jq) {\n");
      out.write("\t\t\t\t\t\t\tInitTable(index);\n");
      out.write("\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t// 请求数据\n");
      out.write("\t\t\t\t\t\tfunction InitTable(pageIndex) {\n");
      out.write("\t\t\t\t\t\t\tvar info = $(\"input[name='info']\").val();\n");
      out.write("\t\t\t\t\t\t\tvar pageIndex = 0;\n");
      out.write("\t\t\t\t\t\t\t$.ajax({\n");
      out.write("\t\t\t\t\t\t\t\ttype : \"get\",\n");
      out.write("\t\t\t\t\t\t\t\turl : 'searchCompetition', // 提交到一般处理程序请求数据\n");
      out.write("\t\t\t\t\t\t\t\tdata:{pageIndex:pageIndex,pageSize:pageSize,info:info},\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tconsole.log(\"pageIndex:\" + pageIndex);\n");
