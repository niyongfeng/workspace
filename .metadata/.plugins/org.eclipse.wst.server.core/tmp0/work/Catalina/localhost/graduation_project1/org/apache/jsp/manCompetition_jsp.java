 ...
 * Generated at: 2017-04-21 16:46:00 UTC
...
public final class manCompetition_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<script type=\"text/javascript\" src=\"javascripts/manCompetition.js\"></script>\n");
	...
	if (user == null) {
      ...
      out.write("\t\t\t\t\t\t<li class=\"active\"><a href=\"manCompetition.jsp\">竞赛活动</a></li>\n");
      ...
      out.write("\t\t\t\t\tselect();\n");
      out.write("\t\t\t\t</script>\n");
      out.write("\t\t\t\t<h1 class=\"page-title\">竞赛活动</h1>\n");
      ...
      out.write("\t\t\t\t\t\t<thead>\n");
      out.write("\t\t\t\t\t\t\t<tr title=\"\" id=\"competitionList\">\n");
      out.write("\t\t\t\t\t\t\t\t<th>#</th>\n");
      ...
      out.write("\t\t\t\t\t\t\tplaceholder=\"Search Help...\" id=\"appendedInputButton\" type=\"text\">\n");
      ...
      out.write("\t\t\t\t\t\t\t$.ajax({\n");
      out.write("\t\t\t\t\t\t\t\ttype : \"get\",\n");
      out.write("\t\t\t\t\t\t\t\turl : 'searchManCompetition', // 提交到一般处理程序请求数据\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t+ \"</td><td>\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t+ val.apply_time\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t+ \"</td><td>\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t+ s\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t+ \"</td><td style=\\\"display:none;\\\">\" + val.id\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t+ \"</td><td><a href=\\\"manCompetitionManage.jsp?id=\"  +val.id + \"\\\"role=\\\"button\\\" data-toggle=\\\"modal\\\"><i class=\\\"icon-pencil\\\"></i></a>&nbsp;&nbsp<a href=\\\"#\\\" role=\\\"button\\\" data-toggle=\\\"modal\\\" onclick='deleteChair($(this))'><i class=\\\"icon-remove\\\"></i></a></td></tr>\";\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t\t\t$(\"#competitionList\").after(str);\n");
      out.write("\t\t\t\t\t\t\t\t\t};\n");
