 ...
 * Generated at: 2017-05-01 03:08:32 UTC
...
public final class manUserManage2_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if (user == null) {
      ...
      out.write("\t\t\t\t\t\t<li class=\"active\"><a href=\"manUserManage2.jsp\">查看用户</a></li>\n");
      ...
      out.write("\t\t\t\t\t\t<li class=\"active\"><a href=\"#home\" data-toggle=\"tab\">查看</a></li>\n");
      out.write("\t\t\t\t\t</ul>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<thead>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<tr title=\"\" id=\"userList\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th>#</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th>用户名</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th>用户密码</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th>用户状态</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th>用户权限</th>\n");
      ...
      out.write("\t\t\t$.ajax({\n");
      out.write("\t\t\t\ttype : \"get\",\n");
      out.write("\t\t\t\turl : 'searchManUser', // 提交到一般处理程序请求数据\n");
      ...
      out.write("\t\t\t\t\t\tif(val.code == 1) {\n");
      out.write("\t\t\t\t\t\t\ts = \"学生\";\n");
      out.write("\t\t\t\t\t\t}else if(val.code == 2) {\n");
      out.write("\t\t\t\t\t\t\ts = \"教师\";\n");
      out.write("\t\t\t\t\t\t}else {\n");
      out.write("\t\t\t\t\t\t\ts = \"管理员\";\n");
      out.write("\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\tvar c = \"\";\n");
      out.write("\t\t\t\t\t\tif(val.status == 0) {\n");
      out.write("\t\t\t\t\t\t\tc = \"已注销\";\n");
      out.write("\t\t\t\t\t\t}else {\n");
      out.write("\t\t\t\t\t\t\tc = \"可用\";\n");
      out.write("\t\t\t\t\t\t}\n");
      ...
      out.write("\t\t\t\t\t\t\t\t+ \"</td><td><a href=\\\"manUserManage.jsp?id=\"  +val.id + \"\\\"role=\\\"button\\\" data-toggle=\\\"modal\\\"><i class=\\\"icon-pencil\\\"></i></a>&nbsp;&nbsp<a href=\\\"#\\\" role=\\\"button\\\" data-toggle=\\\"modal\\\" onclick='deleteChair($(this))'><i class=\\\"icon-remove\\\"></i></a></td></tr>\";\n");
      out.write("\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t$(\"#userList\").after(str);\n");
      out.write("\t\t\t\t\t};\n");
