 ...
 * Generated at: 2017-05-15 01:19:06 UTC
...
public final class studentInfo_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if (user == null) {
      ...
      out.write("\t\t\t\t\t\t<li class=\"active\"><a href=\"studentIndex.jsp\">主页</a></li>\n");
      ...
      out.write("\t\t\t$.ajax({\n");
      out.write("\t\t\t\ttype : \"get\",\n");
      out.write("\t\t\t\turl : 'StudentInfoServlet', \n");
      out.write("\t\t\t\tcache : false, \n");
      out.write("\t\t\t\tsuccess : function(data) {\n");
      out.write("\t\t\t\t\tvar json = eval('('+data+')');\n");
      out.write("\t\t\t\t\tjson = json[0];\n");
      out.write("\t\t\t\t\tconsole.log(json);\n");
      out.write("\t\t\t\t\t$(\"input[name='student_number']\").val(json.student_number);\n");
      out.write("\t\t\t\t\t$(\"input[name='gender']\").val(json.gender);\n");
      out.write("\t\t\t\t\t$(\"input[name='age']\").val(json.age);\n");
      out.write("\t\t\t\t\t$(\"input[name='major']\").val(json.major);\n");
      out.write("\t\t\t\t\t$(\"input[name='phone']\").val(json.phone);\n");
      out.write("\t\t\t\t\t$(\"input[name='email']\").val(json.email);\n");
      out.write("\t\t\t\t}\n");
      out.write("\t\t\t});\n");
      out.write("\t\t\t</script>\n");
      out.write("\t\t\t<div class=\"span9\">\n");
      out.write("\t\t\t\t<h3 class=\"page-title\">个人中心</h3>\n");
      out.write("\t\t\t\t<form id=\"tab2\" action=\"StudentUpdateUserServlet\" method=\"get\">\n");
      ...
      out.write("\t\t\t\t\t<input name=\"student_number\" type=\"text\" class=\"input-xlarge\" readonly>\n");
      out.write("\t\t\t\t\t<label>性别</label>\n");
      out.write("\t\t\t\t\t<input name=\"gender\" type=\"text\" class=\"input-xlarge\"> \n");
      out.write("\t\t\t\t\t<label>年龄</label>\n");
      out.write("\t\t\t\t\t<input name=\"age\" type=\"text\" class=\"input-xlarge\"> \n");
      out.write("\t\t\t\t\t<label>专业</label>\n");
      out.write("\t\t\t\t\t<input name=\"major\" type=\"text\" class=\"input-xlarge\"> \n");
      out.write("\t\t\t\t\t<label>联系电话</label>\n");
      out.write("\t\t\t\t\t<input name=\"phone\" type=\"text\" class=\"input-xlarge\"> \n");
      out.write("\t\t\t\t\t<label>邮箱</label>\n");
      out.write("\t\t\t\t\t<input name=\"email\" type=\"text\" class=\"input-xlarge\"> \n");
      out.write("\t\t\t\t\t<div>\n");
