 ...
 * Generated at: 2017-04-21 16:50:45 UTC
...
public final class manTeacherProjectManage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if (user == null) {
      ...
      out.write("\t\t\t\t\t\t<li class=\"active\"><a href=\"manTeacherProjectManage.jsp\">教师项目管理</a></li>\n");
      out.write("\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t<div class=\"nav-header\" data-toggle=\"collapse\"\n");
      ...
      out.write("\t\t\t\t<h1 class=\"page-title\">教师项目管理</h1>\n");
      ...
      out.write("\t\t\t\t\t\t\t<form id=\"tab\" action=\"manUpdateTeacherProject\" method=\"get\">\n");
      out.write("\t\t\t\t\t\t\t\t<script type=\"text/javascript\"\n");
      out.write("\t\t\t\t\t\t\t\t\tsrc=\"javascripts/manTeacherProject.js\"></script>\n");
      out.write("\t\t\t\t\t\t\t\t<script type=\"text/javascript\">\n");
      out.write("\t\t\t\t\t\t\t\t\tselect();\n");
      out.write("\t\t\t\t\t\t\t\t</script>\n");
      out.write("\t\t\t\t\t\t\t\t<label>项目名</label> <input name=\"name\" type=\"text\"\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"input-xlarge\"> <label>具体内容</label>\n");
      out.write("\t\t\t\t\t\t\t\t<textarea name=\"description\" rows=\"3\" class=\"input-xlarge\"></textarea>\n");
      out.write("\t\t\t\t\t\t\t\t<label>指导老师</label> <input name=\"teacher\" type=\"text\"\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"input-xlarge\"> <label>人数</label> <input\n");
      out.write("\t\t\t\t\t\t\t\t\tname=\"number\" type=\"text\" class=\"input-xlarge\"> <label>状态</label>\n");
      ...
      out.write("\t\t\t\t\t\t\t<form id=\"tab2\" action=\"TeacherProjectManageServlet\" method=\"get\">\n");
      out.write("\t\t\t\t\t\t\t\t<label>项目名</label> <input name=\"name\" type=\"text\"\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"input-xlarge\"> <label>具体内容</label>\n");
      out.write("\t\t\t\t\t\t\t\t<textarea name=\"description\" rows=\"3\" class=\"input-xlarge\"></textarea>\n");
      out.write("\t\t\t\t\t\t\t\t<label>指导老师</label> <input name=\"teacher\" type=\"text\"\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"input-xlarge\"> <label>人数</label> <input\n");
      out.write("\t\t\t\t\t\t\t\t\tname=\"number\" type=\"text\" class=\"input-xlarge\">\n");
      out.write("\t\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<button class=\"btn btn-primary\" style=\"\">发布</button>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
