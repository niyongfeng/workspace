 ...
 * Generated at: 2017-05-15 01:29:49 UTC
...
public final class teacherTeacherProjectManage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if (user == null) {
      ...
      out.write("\t\t\t\t\t\t<li class=\"active\"><a href=\"teacherTeacherProjectManage.jsp\">教师项目发布管理</a></li>\n");
      out.write("\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t<li><a href=\"#show\" data-toggle=\"tab\">我的项目</a></li>\n");
      out.write("\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t<div id=\"myTabContent\" class=\"tab-content\">\n");
      out.write("\t\t\t\t\t\t<div class=\"tab-pane fade\" id=\"profile\">\n");
      out.write("\t\t\t\t\t\t\t<form id=\"tab\" action=\"TeacherProjectManageServlet\" method=\"get\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<button class=\"btn btn-primary\" style=\"submit\">发布</button>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<div class=\"tab-pane active in\" id=\"home\">\n");
      out.write("\t\t\t\t\t\t\t<form id=\"tab2\" action=\"teacherUpdateTeacherProject\" method=\"get\">\n");
      out.write("\t\t\t\t\t\t\t\t<script type=\"text/javascript\"\n");
      out.write("\t\t\t\t\t\t\t\t\tsrc=\"javascripts/teacherMyTeacherProject.js\"></script>\n");
      out.write("\t\t\t\t\t\t\t\t<script type=\"text/javascript\">\n");
      out.write("\t\t\t\t\t\t\t\t\tselect();\n");
      out.write("\t\t\t\t\t\t\t\t</script>\n");
      out.write("\t\t\t\t\t\t\t\t<label>项目名</label> <input name=\"name\" type=\"text\"\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<thead>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<tr title=\"\" id=\"myTeacherProjectList\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th>#</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<th>项目名</th>\n");
      ...
      out.write("\t\t\t$.ajax({\n");
      out.write("\t\t\t\ttype : \"get\",\n");
      out.write("\t\t\t\turl : 'searchMyTeacherProject', // 提交到一般处理程序请求数据\n");
      ...
      out.write("\t\t\t\t\t\t\t\t+ \"</td><td><a href=\\\"teacherTeacherProjectManage.jsp?id=\"  +val.id + \"\\\"role=\\\"button\\\" data-toggle=\\\"modal\\\"><i class=\\\"icon-pencil\\\"></i></a>&nbsp;&nbsp<a href=\\\"#\\\" role=\\\"button\\\" data-toggle=\\\"modal\\\" onclick='deleteChair($(this))'><i class=\\\"icon-remove\\\"></i></a></td></tr>\";\n");
      out.write("\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t$(\"#myTeacherProjectList\").after(str);\n");
      out.write("\t\t\t\t\t};\n");
