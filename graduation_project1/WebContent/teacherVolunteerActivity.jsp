...
<script type="text/javascript" src="javascripts/volunteerActivity2.js"></script>
...
<body>
			...
			<div class="span3">
				<div class="sidebar-nav">
					...
					<ul id="dashboard-menu" class="nav nav-list collapse in">
						...
						<li class="active"><a href="teacherVolunteerActivity.jsp">志愿者活动</a></li>
 ...
 $("#search").click(function(){
	 var info = $("input[name='info']").val();
		$.ajax({
			type : "get",
			url : 'searchVolunteerActivity', // 提交到一般处理程序请求数据
			data:{info:info},
