			...
			<div class="span3">
				<div class="sidebar-nav">
					...
					<ul id="accounts-menu" class="nav nav-list collapse in">
						<li class="active"><a href="manVolunteerActivityManage.jsp">志愿者活动管理</a></li>
				...
				<div class="well">
					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active in" id="home">
							<form id="tab" action="manUpdateVolunteerActivity" method="get">
								...
								<label>人数</label> <input name="number" type="text"
									class="input-xlarge"> <label>地点</label>
									 <input
						...
						<div class="tab-pane fade" id="profile">
							<form id="tab1" action="VolunteerActivityManageServlet"
								method="get">
