...
<body>
			...
			<div class="span3">
				<div class="sidebar-nav">
					...
					<ul id="accounts-menu" class="nav nav-list collapse in">
						...
						<li class="active"><a href="teacherTeacherProjectManage.jsp">教师项目发布管理</a></li>
					</ul>
				</div>
			</div>
			<div class="span9">
				<h1 class="page-title">教师项目管理</h1>
				...
				<div class="well">
					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane fade" id="profile">
							<form id="tab" action="TeacherProjectManageServlet" method="get">
								...
								<div>
									<button class="btn btn-primary" style="submit">发布</button>
								</div>
							</form>
						</div>
						<div class="tab-pane active in" id="home">
							<form id="tab2" action="teacherUpdateTeacherProject" method="get">
								<script type="text/javascript"
									src="javascripts/teacherMyTeacherProject.js"></script>
								<script type="text/javascript">
									select();
								</script>
								<label>项目名</label> <input name="name" type="text"
								...
								<label>指导老师</label> <input name="teacher" type="text"
									class="input-xlarge"> <label>人数</label> <input
									name="number" type="text" class="input-xlarge"> <label>状态</label>
						...
						<h6 id="tatol" style="display:none">搜索结果:<a id = "number">${number}</a></h6>
							<form id="tab3">
								...
								<div class="well">
									<table class="table">
										<thead>
											<tr title="" id="myTeacherProjectList">
												<th>#</th>
												<th>项目名</th>
												<th>指导教师</th>
												<th>具体内容</th>
 ...
 $("#search").click(function(){
			...
			$.ajax({
				type : "get",
				url : 'searchMyTeacherProject', // 提交到一般处理程序请求数据
				data:{info:info},
				...
				success : function(data) {
					...
					for (var i = 0; i < json.length; i++) {
						...
						var str = "<tr><td>"+ (json.length - i)
								...
								+ "</td><td><a href=\"teacherTeacherProjectManage.jsp?id="  +val.id + "\"role=\"button\" data-toggle=\"modal\"><i class=\"icon-pencil\"></i></a>&nbsp;&nbsp<a href=\"#\" role=\"button\" data-toggle=\"modal\" onclick='deleteChair($(this))'><i class=\"icon-remove\"></i></a></td></tr>";
								
						$("#myTeacherProjectList").after(str);
					};
					$("#Pagination").hide();
