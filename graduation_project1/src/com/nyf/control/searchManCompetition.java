...
/**
 * Servlet implementation class searchManCompetition
 */
@WebServlet("/searchManCompetition")
public class searchManCompetition extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public searchManCompetition() {
        super();
