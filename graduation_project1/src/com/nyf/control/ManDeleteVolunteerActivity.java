...
/**
 * Servlet implementation class ManDeleteVolunteerActivity
 */
@WebServlet("/ManDeleteVolunteerActivity")
public class ManDeleteVolunteerActivity extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ManDeleteVolunteerActivity() {
        super();
