...
/**
 * Servlet implementation class manUpdateCompetitionId
 */
@WebServlet("/manUpdateCompetitionId")
public class manUpdateCompetitionId extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public manUpdateCompetitionId() {
        super();
