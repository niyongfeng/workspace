...
/**
 * Servlet implementation class searchManVolunteerActivity
 */
@WebServlet("/searchManVolunteerActivity")
public class searchManVolunteerActivity extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public searchManVolunteerActivity() {
        super();
