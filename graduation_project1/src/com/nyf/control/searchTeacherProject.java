...
/**
 * Servlet implementation class searchTeacherProject
 */
@WebServlet("/searchTeacherProject")
public class searchTeacherProject extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public searchTeacherProject() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<TeacherProject> activities = vad.selectByString(info);
