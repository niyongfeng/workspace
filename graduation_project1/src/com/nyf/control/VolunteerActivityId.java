...
/**
 * Servlet implementation class VolunteerActivityId
 */
@WebServlet("/VolunteerActivityId")
public class VolunteerActivityId extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public VolunteerActivityId() {
        super();
