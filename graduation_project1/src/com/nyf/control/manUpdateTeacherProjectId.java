...
/**
 * Servlet implementation class manUpdateTeacherProjectId
 */
@WebServlet("/manUpdateTeacherProjectId")
public class manUpdateTeacherProjectId extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public manUpdateTeacherProjectId() {
        super();
