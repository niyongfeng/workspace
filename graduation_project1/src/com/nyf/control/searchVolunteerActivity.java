...
/**
 * Servlet implementation class searchVolunteerActivity
 */
@WebServlet("/searchVolunteerActivity")
public class searchVolunteerActivity extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public searchVolunteerActivity() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<VolunteerActivity> activities = vad.selectByString(info);
