...
/**
 * Servlet implementation class TeacherMyCompetitionServlet
 */
@WebServlet("/TeacherMyCompetitionServlet")
public class TeacherMyCompetitionServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TeacherMyCompetitionServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Competition> activities = vad.selectByLogin_id(i);
