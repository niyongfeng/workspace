...
/**
 * Servlet implementation class manTeacherProjectServlet
 */
@WebServlet("/manTeacherProjectServlet")
public class manTeacherProjectServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public manTeacherProjectServlet() {
        super();
